...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Donation of medical equipment</title>
...
<body>
    ...
    <div class="container">
      <header>Donation of medical equipment</header>
      ...
      <div class="form-outer">
        <form action="../PHP/registrar_donacion_2.php" method="post">
          ...
          <div class="page">
            <div class="field">
              <div class="label">Name of medical team</div>
              <input type="text" name="equipo" required>
            </div>
            <div class="field">
              <div class="label">Quantity of medical equipment</div>
          ...
          <div class="page">
            ...
            <div class="field">
              <div class="label">Description of medical equipment</div>
